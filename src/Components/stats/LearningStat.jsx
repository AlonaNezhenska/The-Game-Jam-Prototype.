function LearningStat({ learningStat, setLearning }) {
    ...
    const learningScore = learningStat;
    ...
    const createGridItems = () => {
        ...
        for (let i = 0; i < 5; i++) {
            const isDisabled = learningStat < disableThresholds[i][0];
            const isRangeActive = learningStat >= disableThresholds[i][0];
            const itemStyle = {
            ...
            items.push(
                <div
                    key={i}
                    style={itemStyle}
                    // onClick={() => !isDisabled && setLearning(learningStat + 1)}
                >
